...
namespace projeto_destino_certo.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
         ...
         public IActionResult Reserva(Reserva itens)
        {   
            UsuarioRepository ur = new UsuarioRepository();
            ur.Insert_r(itens);
            ViewBag.Reserva = "Reserva concluída com sucesso!";
            return View();
        }

        /*LISTAGEM DE RESERVAS*/      
        
        public IActionResult Listar_Reservas()
        {   
            if(HttpContext.Session.GetInt32("id_usuarios") == null)
            return RedirectToAction("Login");
            ...
            UsuarioRepository ur = new UsuarioRepository();
            List<Reserva> list = ur.Listar_Reservas();
            return View(list);
        }

        /*ALTERAÇÃO DE RESERVAS*/    
        [HttpGet]
         public IActionResult Alterar_Reserva(int id)
        {   
            UsuarioRepository ur = new UsuarioRepository();
            
            Reserva itens = ur.RetornoReserva(id);
        
            return View(itens);
        }

        [HttpPost]
        public IActionResult Alterar_Reserva(Reserva reserva)
        {  

            UsuarioRepository ur = new UsuarioRepository();
            
            ur.Alterar_r(reserva);
             
            return RedirectToAction("Listar_Reservas"); 
            
        }

        /*EXCLUSÃO DE RESERVAS  */ 
        [HttpGet]
        public IActionResult Excluir_Reserva(int id){
